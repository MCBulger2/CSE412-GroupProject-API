...
export PGHOST=/tmp
initdb ~/$1
pg_ctl -D ~/$1 -o '-k /tmp' start
createdb $1

#  Create the database schema using DDL

psql -U $USER -d $1 -c "CREATE TABLE Profile (
...
psql -U $USER -d $1 -c "CREATE TABLE Conversation (
	conversation_id SERIAL PRIMARY KEY,
	name TEXT
);"
psql -U $USER -d $1 -c "CREATE TABLE ConversationMessage (
...
psql -U $USER -d $1 -c "CREATE TABLE ConversationUsers (
...
psql -U $USER -d $1 -c "CREATE TABLE Friend (
...
psql -U $USER -d $1 -c "INSERT INTO Profile (username, name, birthday, pw_hash) VALUES 
...
# Friendships
psql -U $USER -d $1 -c "INSERT INTO Friend VALUES (1, 2), (2, 1), (1, 3), (3, 1), (2, 3), (3, 2);"      # First 3 users are all friends with each other
psql -U $USER -d $1 -c "INSERT INTO Friend VALUES (4, 1), (5, 1), (4, 5), (5, 4);"                      # 4 and 5 are friends with 1 but not vice versa, and friends with each other
psql -U $USER -d $1 -c "INSERT INTO Friend VALUES (6, 2), (2, 6), (6, 3), (4, 6);"
psql -U $USER -d $1 -c "INSERT INTO Friend VALUES (7, 6), (6, 7), (7, 5), (5, 7);"
psql -U $USER -d $1 -c "INSERT INTO Friend VALUES (8, 9), (8, 10), (8, 11), (8, 12);"
psql -U $USER -d $1 -c "INSERT INTO Friend VALUES (9, 8), (9, 10), (9, 11), (9, 12);"
psql -U $USER -d $1 -c "INSERT INTO Friend VALUES (10, 11), (10, 8), (10, 9);"
psql -U $USER -d $1 -c "INSERT INTO Friend VALUES (11, 10), (11, 8), (11, 9);"
psql -U $USER -d $1 -c "INSERT INTO Friend VALUES (12, 10), (12, 8), (12, 9);"
psql -U $USER -d $1 -c "INSERT INTO Friend VALUES (30, 29), (29, 30);"
psql -U $USER -d $1 -c "INSERT INTO Friend VALUES (29, 28), (28, 29);"
psql -U $USER -d $1 -c "INSERT INTO Friend VALUES (28, 27), (27, 28);"
psql -U $USER -d $1 -c "INSERT INTO Friend VALUES (27, 26), (26, 27);"


# Create conversations
psql -U $USER -d $1 -c "INSERT INTO Conversation (name) VALUES ('Group Convo 1');"
psql -U $USER -d $1 -c "INSERT INTO ConversationUsers VALUES (1, 1), (1, 2), (1, 3);"
psql -U $USER -d $1 -c "INSERT INTO ConversationMessage (content, sender_id, conversation_id) VALUES 
    ('Hello, World!', 1, 1),
    ('Hello, back!', 2, 1),
    ('Same here, hello', 3, 1),
...
psql -U $USER -d $1 -c "INSERT INTO Conversation (name) VALUES ('Normal Convo 1');"
psql -U $USER -d $1 -c "INSERT INTO ConversationUsers VALUES (2, 1), (2, 2);"
psql -U $USER -d $1 -c "INSERT INTO ConversationMessage (content, sender_id, conversation_id) VALUES 
...
psql -U $USER -d $1 -c "INSERT INTO Conversation (name) VALUES ('Normal Convo 2');"
psql -U $USER -d $1 -c "INSERT INTO ConversationUsers VALUES (3, 7), (2, 5);"
psql -U $USER -d $1 -c "INSERT INTO ConversationMessage (content, sender_id, conversation_id) VALUES 
...
psql -U $USER -d $1 -c "INSERT INTO Conversation (name) VALUES ('Normal Convo 3');"
psql -U $USER -d $1 -c "INSERT INTO ConversationUsers VALUES (4, 2), (4, 4);"
psql -U $USER -d $1 -c "INSERT INTO ConversationMessage (content, sender_id, conversation_id) VALUES 
    ('This is a private conversation between us', 2, 4),
    ('Sounds good, its just us then', 4, 4)
;"

psql -U $USER -d $1 -c "INSERT INTO Conversation (name) VALUES ('Normal Convo 4');"
psql -U $USER -d $1 -c "INSERT INTO ConversationUsers VALUES (5, 8), (5, 7);"
psql -U $USER -d $1 -c "INSERT INTO ConversationMessage (content, sender_id, conversation_id) VALUES 
...
psql -U $USER -d $1 -c "INSERT INTO Conversation (name) VALUES ('Normal Convo 5');"
psql -U $USER -d $1 -c "INSERT INTO ConversationUsers VALUES (6, 30), (6, 29);"
psql -U $USER -d $1 -c "INSERT INTO ConversationMessage (content, sender_id, conversation_id) VALUES 
    ('This is a private conversation between us', 30, 6),
    ('Sounds good, its just us then', 29, 6)
;"

psql -U $USER -d $1 -c "INSERT INTO Conversation (name) VALUES ('Normal Convo 6');"
psql -U $USER -d $1 -c "INSERT INTO ConversationUsers VALUES (7, 29), (7, 28);"
psql -U $USER -d $1 -c "INSERT INTO ConversationMessage (content, sender_id, conversation_id) VALUES 
    ('This is a private conversation between us', 29, 7),
    ('Sounds good, its just us then', 28, 7)
;"

psql -U $USER -d $1 -c "INSERT INTO Conversation (name) VALUES ('Group Convo 2');"
psql -U $USER -d $1 -c "INSERT INTO ConversationUsers VALUES (8, 9), (8, 10), (8, 11);"
psql -U $USER -d $1 -c "INSERT INTO ConversationMessage (content, sender_id, conversation_id) VALUES 
    ('message1', 8, 8),
    ('message2', 9, 8),
    ('message2', 10, 8)
...
psql -U $USER -d $1 -c "INSERT INTO Conversation (name) VALUES ('Normal Convo 7');"
psql -U $USER -d $1 -c "INSERT INTO ConversationUsers VALUES (9, 27), (9, 26);"
psql -U $USER -d $1 -c "INSERT INTO ConversationMessage (content, sender_id, conversation_id) VALUES 
    ('This is a private conversation between us', 27, 7),
    ('Sounds good, its just us then', 26, 7)
;"

psql -U $USER -d $1 -c "INSERT INTO Conversation (name) VALUES ('Normal Convo 8');"
psql -U $USER -d $1 -c "INSERT INTO ConversationUsers VALUES (10, 26), (10, 25);"
psql -U $USER -d $1 -c "INSERT INTO ConversationMessage (content, sender_id, conversation_id) VALUES 
...
psql -U $USER -d $1 -c "INSERT INTO ConversationMessage (content, sender_id, isfeedmessage) VALUES
